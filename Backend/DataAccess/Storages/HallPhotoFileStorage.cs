...
{
    public class HallPhotoFileStorage
    {
        private readonly StorageOptions _storageSnapshotOptions;

        public HallPhotoFileStorage(IOptionsSnapshot<StorageOptions> storageSnapshotOptionsAccessor)
        {
        ...
        {
            return Path.Combine(_storageSnapshotOptions.Path, _storageSnapshotOptions.Halls);
        }
    }
}
