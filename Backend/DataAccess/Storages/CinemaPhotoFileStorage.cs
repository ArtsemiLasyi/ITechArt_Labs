...
{
    public class CinemaPhotoFileStorage
    {
        private readonly StorageOptions _storageSnapshotOptions;

        public CinemaPhotoFileStorage(IOptionsSnapshot<StorageOptions> storageSnapshotOptionsAccessor)
        {
        ...
        {
            return Path.Combine(_storageSnapshotOptions.Path, _storageSnapshotOptions.Cinemas);
        }
    }
}
